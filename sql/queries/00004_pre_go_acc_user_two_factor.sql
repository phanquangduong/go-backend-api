...
UPDATE pre_go_acc_user_two_factor
...
SELECT COUNT(*)
FROM pre_go_acc_user_two_factor
...
INSERT INTO pre_go_acc_user_two_factor (user_id, two_factor_phone, two_factor_is_active)
VALUES (?, ?, TRUE)
...
INSERT INTO pre_go_acc_user_two_factor (user_id, two_factor_email, two_factor_is_active)
VALUES (?, ?, TRUE)
ON DUPLICATE KEY UPDATE 
    two_factor_email = ?, 
    two_factor_updated_at = NOW();
...
DELETE FROM pre_go_acc_user_two_factor
WHERE user_id = ? AND two_factor_auth_type = ?;
