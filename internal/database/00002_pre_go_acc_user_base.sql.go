...
// versions:
//   sqlc v1.28.0
// source: 00002_pre_go_acc_user_base.sql
...
func (q *Queries) GetOneUserInfoAdmin(ctx context.Context, userAccount string) (PreGoAccUserBase, error) {
	row := q.db.QueryRowContext(ctx, getOneUserInfoAdmin, userAccount)
	var i PreGoAccUserBase
	err := row.Scan(
		&i.UserID,
		&i.UserAccount,
		&i.UserPassword,
